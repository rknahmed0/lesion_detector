...
public class YoloV5Classifier implements Classifier {
    ...
    public static YoloV5Classifier create(
        ...
        try {
            ...
            if (isNNAPI) {
                Log.d("YoloV5Classifier", "isNNAPI True"); // SRA
...
//                    options.setAllowBufferHandleOutput(true);
            ...
            if (isGPU) {
                Log.d("YoloV5Classifier", "isGPU True"); // SRA
            ...
            Log.d("YoloV5Classifier", "isGPU/isNNAPI False"); // SRA
        } catch (Exception e) {
...
//    private int[] ANCHORS;
    ...
    private static boolean isNNAPI = false; // SRA changed to true
    private static boolean isGPU = false; // SRA changed to true
